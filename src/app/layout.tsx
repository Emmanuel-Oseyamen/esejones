...
export const metadata: Metadata = {
  title: {
    default: "Ese Jones Hotels",
    template: "%s | Ese Jones Hotels",
  },

  description:
    "Ese Jones Hotels — exceptional hospitality, beautifully considered spaces, and memorable stays.",
  ...
  creator: "Ese Jones Hotels",

  metadataBase: new URL("https://esejoneshotels.com"),

  openGraph: {
    title: "Ese Jones Hotels",
    description:
      "Exceptional hospitality. Beautifully considered spaces. Memorable stays.",
    type: "website",
    siteName: "Ese Jones Hotels",
  },
