...
const CONTACT_DETAILS = [
  ...
  },
  {
    ...
    href: "mailto:hello@esejones.com",
  },
  {
    icon: Clock3,
    eyebrow: "Always",
...
export function Contact() {
  ...
  return (
    ...
    >
      {/* Intro */}
      <div className="esejones-container border-b border-foreground/10 py-20 sm:py-28 lg:py-36">
        <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
          <div>
            <p className="esejones-eyebrow">
              Get in touch
            </p>
          ...
          <div>
            <h2 className="esejones-display max-w-4xl">
              Good conversations
              <br />
      ...
      {/* Contact details */}
      <div className="esejones-container border-b border-foreground/10">
      ...
      {/* Main enquiry area */}
      <div className="esejones-container py-20 sm:py-28 lg:py-32">
        <div className="grid gap-16 lg:grid-cols-[0.72fr_1.28fr] lg:gap-24">
          ...
          <div>
            ...
            <p className="mt-7 max-w-sm text-sm leading-7 text-foreground/45">
              ...
              anything else that will make your Ese Jones
              experience better.
            </p>
                ...
                >
                  ...
                  <div className="flex flex-col gap-5 border-t border-foreground/10 pt-6 sm:flex-row sm:items-center sm:justify-between">
                    <p className="max-w-sm text-[9px] leading-5 text-foreground/30">
                      ...
                      Ese Jones Hotels may use the information
      ...
      <div className="bg-charcoal">
        <div className="esejones-container py-16 sm:py-20">
          <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
            <div>
              ...
              <p className="mt-4 max-w-xs text-xs leading-6 text-ivory/35">
                A little Ese Jones in your inbox, from time
                to time.
              </p>
            </div>
