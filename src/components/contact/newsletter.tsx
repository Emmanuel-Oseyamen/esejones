...
export function Newsletter({
  ...
  description = "Occasional notes from Ese Jones — new experiences, seasonal moments and reasons to stay a little longer.",
  className = "",
}: NewsletterProps) {
  ...
  return (
    <div className={className}>
      ...
      >
        ...
        >
          No noise. Just occasional Ese Jones news,
