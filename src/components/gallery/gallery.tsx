...
const galleryImages: GalleryImage[] = [
  ...
  },
  {
    id: "evening",
    src: "/gallery/6.png",
    alt: "Ese Jones evening atmosphere",
    category: "Evenings",
...
export default function Gallery() {
  ...
  return (
    <>
      ...
      >
        <div className="esejones-container py-24 sm:py-32 lg:py-40">
          {/* Header */}
          <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
            ...
            >
              <span className="esejones-eyebrow">
                <span className="mr-3 inline-block h-px w-8 bg-gold" />
                A glimpse of Ese Jones
              </span>

              <h2 className="esejones-display mt-5 max-w-3xl text-5xl leading-[0.9] tracking-[-0.04em] sm:text-6xl lg:text-8xl">
                See the place.
