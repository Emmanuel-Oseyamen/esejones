...
const testimonials: Testimonial[] = [
  ...
  },
  {
    id: "guest-03",
    quote:
      "Beautiful rooms, excellent food and a team that actually pays attention. Ese Jones has become our first choice.",
    name: "Chinonso E.",
      ...
      <div className="esejones-container py-24 sm:py-32 lg:py-40">
        <div className="grid gap-14 lg:grid-cols-[0.65fr_1.35fr]">
          ...
          >
            ...
            <h2 className="esejones-display mt-5 max-w-md text-5xl leading-[0.92] tracking-[-0.035em] sm:text-6xl lg:text-7xl">
              The best
            ...
            <div className="mt-8 flex items-center gap-3">
              ...
              <p className="text-[10px] uppercase tracking-[0.17em] text-muted-foreground">
                What staying at Ese Jones feels like
              </p>
            </div>
          </motion.div>
