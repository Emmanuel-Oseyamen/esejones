...
export default function Rooms() {
  ...
  return (
    <>
      <section
        id="rooms"
        className="esejones-section overflow-hidden bg-background"
      >
        <div className="esejones-container">
          ...
          <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
            ...
            >
              ...
              <h2 className="esejones-display mt-5 max-w-xl text-5xl leading-[0.95] tracking-[-0.035em] sm:text-6xl lg:text-7xl">
                Rooms made for
            ...
            >
              <p className="text-base leading-7 text-muted-foreground sm:text-lg">
                From intimate rooms to expansive suites, every Ese Jones space
