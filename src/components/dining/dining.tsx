...
const restaurants: Restaurant[] = [
  {
    id: "the-esejones-table",
    number: "01",
    name: "The Ese Jones Table",
    type: "All-day dining",
    description:
  ...
  return (
    ...
    >
      <div className="esejones-container py-24 sm:py-32 lg:py-40">
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_auto] lg:items-end">
          ...
          >
            ...
            <h2 className="esejones-display mt-5 max-w-3xl text-5xl leading-[0.92] tracking-[-0.04em] sm:text-6xl lg:text-8xl">
              Come hungry.
      ...
      <div className="relative h-[45vh] min-h-[360px] overflow-hidden sm:h-[55vh]">
        <Image
          src="/dining/dining.png"
          alt="Ese Jones dining atmosphere"
          fill
          sizes="100vw"
