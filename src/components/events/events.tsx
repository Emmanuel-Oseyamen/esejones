        ...
        <div className="esejones-container py-24 sm:py-32 lg:py-40">
          ...
          <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
            ...
            >
              ...
              <h2 className="esejones-display mt-5 max-w-2xl text-5xl leading-[0.9] tracking-[-0.04em] sm:text-6xl lg:text-8xl">
                Make the
            ...
            >
              <p className="text-base leading-7 text-muted-foreground sm:text-lg">
                ...
                hundreds of guests, Ese Jones gives every gathering the space,
