  ...
  return (
    <>
      ...
      >
        ...
        <div className="esejones-container relative py-24 sm:py-32 lg:py-40">
          {/* Header */}
          <div className="grid gap-10 lg:grid-cols-[1fr_0.8fr] lg:items-end">
            ...
            >
              <span className="esejones-eyebrow text-white/60">
                <span className="mr-3 inline-block h-px w-8 bg-gold" />
                Experience Ese Jones
              </span>

              <h2 className="esejones-display mt-5 max-w-4xl text-5xl leading-[0.9] tracking-[-0.04em] text-white sm:text-6xl lg:text-8xl">
                Stay for the room.
            ...
            >
              ...
              <div className="mt-7 flex items-center gap-3 text-[10px] uppercase tracking-[0.2em] text-gold">
                <ArrowDownRight
                  ...
                  strokeWidth={1.3}
                />
                Discover your Ese Jones moment
              </div>
            </motion.div>
          </div>
