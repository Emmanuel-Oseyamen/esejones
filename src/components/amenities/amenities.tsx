      ...
      <div className="esejones-container relative py-24 sm:py-32 lg:py-40">
        ...
        <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-end">
          ...
          >
            ...
            <h2 className="esejones-display mt-5 max-w-2xl text-5xl leading-[0.92] tracking-[-0.035em] text-white sm:text-6xl lg:text-7xl">
              More than a room.
        ...
        >
          <div className="relative aspect-[4/3] sm:aspect-[16/8]">
            <Image
              ...
              alt="Ese Jones wellness experience"
              fill
              sizes="100vw"
